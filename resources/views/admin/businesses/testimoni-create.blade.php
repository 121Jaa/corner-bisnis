        ...
        <div class="flex-1 p-4 lg:p-8 w-full">
            <div class="bg-white rounded-2xl lg:rounded-3xl shadow-2xl p-4 lg:p-8 border border-gray-100">
                <div class="mb-6">
                    ...
                    <h2 class="font-serif text-2xl lg:text-4xl font-bold text-[#4a1e2b]">Tambah Testimoni</h2>
                </div>
                ...
                <form action="{{ route('testimoni.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" placeholder="Nama pemberi testimoni" class="w-full border-2 border-gray-300 rounded-lg p-2 focus:outline-none focus:border-[#4a1e2b]" required>
                    </div>

                    <div class="mb-4">
                        <label class="block text-sm font-medium mb-2">Konten</label>
                        <textarea name="content" rows="4" placeholder="Tulis testimoni..." class="w-full border-2 border-gray-300 rounded-lg p-2 focus:outline-none focus:border-[#4a1e2b]" required></textarea>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-xs text-gray-500 mt-2" id="rating-text">5 dari 5 bintang</p>
                    </div>
