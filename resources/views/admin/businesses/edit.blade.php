        ...
        <div class="flex-1 p-8">
            <div class="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
                <div class="mb-6">
                    ...
                    <h2 class="font-serif text-4xl font-bold text-[#4a1e2b]">Edit Usaha</h2>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="url" name="google_maps_link" id="mapsLinkInput" value="{{ $business->google_maps_link ?? '' }}" placeholder="https://maps.app.goo.gl/xxxxx atau https://www.google.com/maps/..." class="w-full border-2 border-gray-300 rounded-lg p-2 focus:outline-none focus:border-[#4a1e2b]">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="facilities" value="{{ $business->facilities }}" placeholder="Fasilitas 1, Fasilitas 2, Fasilitas 3" class="w-full border-2 border-gray-300 rounded-lg p-2 focus:outline-none focus:border-[#4a1e2b]">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-4 rounded-xl overflow-hidden border border-gray-200 shadow-sm">
                                ...
                                <div id="mapContainer" class="relative" style="height: 350px;">
                                    <iframe 
                                        id="mapIframe"
                                        src="https://www.google.com/maps?q={{ urlencode($business->address ?? 'RT 04 Ngijo, Karangploso, Malang') }}&output=embed"
                                        width="100%" 
                                        height="350" 
                                        style="border:0;" 
                                        allowfullscreen="" 
...
<script>
    ...
    function extractPlaceName(url) {
        ...
        // Format: /place/Nama+Tempat/
        let match = url.match(/place\/([^\/@]+)/);
        if (match) {
            return decodeURIComponent(match[1].replace(/\+/g, ' '));
        }
        
        // Format: ?q=Nama+Tempat
        match = url.match(/[?&]q=([^&]+)/);
    ...
    // Fungsi update peta berdasarkan link Google Maps
    function updateMap() {
    ...
    // Refresh peta saat halaman dimuat jika ada link
    window.addEventListener('load', function() {
        if (mapsLinkInput.value) {
            updateMap();
        }
    });
</script>
