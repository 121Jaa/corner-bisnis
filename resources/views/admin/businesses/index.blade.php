                ...
                <div class="md:hidden mt-4 space-y-4">
                    ...
                    <div class="border border-gray-200 rounded-xl p-4 bg-gray-50">
                        <div class="flex justify-between items-start mb-2">
                            <span class="inline-block px-3 py-1 rounded-full text-xs font-semibold bg-[#4a1e2b] text-white">
                        ...
                        <p class="text-xs text-gray-500 mt-2 line-clamp-2">{{ $business->description }}</p>
