            ...
            <div class="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <h2 class="font-serif text-4xl font-bold text-[#4a1e2b]">Daftar Usaha</h2>
                    </div>
                    <a href="{{ route('admin.businesses.create') }}" class="bg-gradient-to-r from-[#4a1e2b] to-[#7A384D] rounded-full px-6 py-3 text-white font-bold hover:opacity-90 transition">
                        + Tambah Usaha
                    </a>
                </div>
