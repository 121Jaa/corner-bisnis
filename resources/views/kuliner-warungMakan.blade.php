...
<head>
    ...
    <title>Warung Makan - Corner Bisnis RT 04</title>
    ...
    <section class="bg-white py-24">
        <div class="mx-auto max-w-7xl px-6">
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                @forelse ($kulinerWarungMakan as $item)
                    <a href="{{ route('kuliner.show', $item->id) }}"
                ...
                @empty
                    <div class="col-span-3 text-center py-20">
                        <p class="text-4xl">🏪</p>
                        <p class="mt-4 text-lg text-gray-500">Belum ada warung makan yang terdaftar.</p>
                    </div>
                @endforelse
            </div>
        </div>
