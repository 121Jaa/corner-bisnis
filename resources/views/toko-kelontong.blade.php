...
<head>
    ...
    <title>Toko Kelontong - Corner Bisnis RT 04</title>
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                @empty
                    <div class="col-span-3 text-center py-20">
                        <p class="text-4xl">🏪</p>
                        <p class="mt-4 text-lg text-gray-500">Belum ada toko kelontong yang terdaftar.</p>
                    </div>
                @endforelse
            </div>
        </div>
    ...
    <section class="bg-white pb-24">
        <div class="mx-auto max-w-7xl px-6">
            <div class="text-center">
                <a href="{{ route('toko') }}" class="inline-block rounded-lg bg-gray-900 px-6 py-3 font-medium text-white transition hover:bg-yellow-500">
