...
<head>
    ...
    <title>Kos Putra - Corner Bisnis RT 04</title>
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <a href="{{ route('kos.show', $item->id) }}"
                        ...
                        <div class="relative h-64 overflow-hidden">
                            ...
                            <div
                                ...
                                {{ $item->category->name ?? 'Kos' }}
                            </div>
                        </div>
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-900">{{ $item->type ?? $item->name }}</h3>
                            <p class="mt-2 text-sm leading-6 text-gray-600">
                                {{ $item->description ?? 'Deskripsi singkat kos ini akan segera ditambahkan.' }}
                            </p>
                ...
                @empty
                    <div class="col-span-3 text-center py-20">
                        <p class="text-4xl">🏪</p>
                        <p class="mt-4 text-lg text-gray-500">Belum ada kos putra yang terdaftar.</p>
                    </div>
                @endforelse
            </div>
        </div>
