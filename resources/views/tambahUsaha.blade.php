    ...
    <div class="min-h-screen flex pt-14 lg:pt-0">
        ...
        <div class="flex-1 p-4 lg:p-8 w-full">
            <div class="bg-white rounded-2xl lg:rounded-3xl shadow-2xl p-4 lg:p-8 border border-gray-100">
                ...
                <p class="mt-2 text-xs lg:text-sm text-gray-600">Isi form di bawah ini untuk menambahkan usaha baru.</p>

                <form action="{{ route('admin.businesses.store') }}" method="POST" enctype="multipart/form-data" class="mt-6">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" placeholder="Contoh: Seafood" class="w-full border-2 border-gray-300 rounded-lg p-2 focus:outline-none focus:border-[#4a1e2b]" required>
                    </div>

                    <div class="flex flex-col sm:flex-row justify-end gap-3">
                        <a href="{{ route('dashboard') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-lg text-center transition">Batal</a>
            ...
            <!-- Tabel Daftar Usaha -->
            <div class="mt-6 lg:mt-8 bg-white rounded-2xl lg:rounded-3xl shadow-2xl p-4 lg:p-8 border border-gray-100">
                <h3 class="font-serif text-xl lg:text-2xl font-bold text-[#4a1e2b] mb-6">Daftar Usaha</h3>
                ...
                <div class="md:hidden space-y-4">
                    ...
                    <div class="border border-gray-200 rounded-xl p-4 bg-gray-50">
                        ...
                        <h4 class="font-bold text-base text-gray-900">{{ $business->name }}</h4>
