...
<head>
    ...
    <title>Laundry - Corner Bisnis RT 04</title>
        ...
        <div class="mx-auto max-w-7xl px-6">
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                @forelse ($laundry as $item)
                    <a href="{{ route('laundry.show', $item->id) }}"
                ...
                @empty
                    <div class="col-span-3 text-center py-20">
                        <p class="text-4xl">🏪</p>
                        <p class="mt-4 text-lg text-gray-500">Belum ada laundry yang terdaftar.</p>
                    </div>
                @endforelse
            </div>
        </div>
