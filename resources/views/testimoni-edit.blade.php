    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-8">
            <div class="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
                <h2 class="font-serif text-4xl font-bold text-[#4a1e2b]">Edit Testimoni</h2>
                ...
                <form action="{{ route('testimoni.update', $testimonial->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" value="{{ $testimonial->name }}" class="w-full border-2 border-gray-300 rounded p-2" required>
                    </div>

                    <div class="mb-4">
                        <label class="block text-sm font-medium mb-2">Konten</label>
                        <textarea name="content" rows="4" class="w-full border-2 border-gray-300 rounded p-2">{{ $testimonial->content }}</textarea>
                    </div>
